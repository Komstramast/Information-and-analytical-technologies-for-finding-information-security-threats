...
-   Адрес почты вызывает подозрения. Например, организация использует адреса в виде <a href="mailto:name@example.com"
    class="email"><em>[name\@example.com](mailto:name@example.com){.email}</em></a>, а письмо пришло с адреса <a href="mailto:name.example@gmail.com"
    class="email"><em>[name.example\@gmail.com](mailto:name.example@gmail.com){.email}</em></a>. Либо в имени сотрудника есть опечатки.
...
Антивирусные программы сегодня не только сканируют загружаемые программы на предмет вредоносных кодов, но и могут определять фишинговые сайты.
...
![](img/5.png)<sup>*Пример фильтров, которые можно настроить в Gmail*</sup>

![](img/6.png)<sup>*Пример настройки правил для вложений в Microsoft Exchange Online*</sup>
