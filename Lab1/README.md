...
are  
not required, but can often improve readability by making code appear
less  
...
|======================================================= | 89% | Earlier
in the lesson, you computed z \* 2 + 100. Let’s pretend that you | made
a mistake and that you meant to add 1000 instead of 100. You could |
...
this | command (z \* 2 + 100), then change 100 to 1000 and hit Enter. If
the up | arrow doesn’t work for you, just type the corrected command.
